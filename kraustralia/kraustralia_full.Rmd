...
<!-- Day 23 -->
<!-- Grampians NP -->
<!-- In efforts to explore our new state of Victoria, we took a quick two day trip out for some bushwalking in the Grampians National Park.  The Grampians Mountain Range, or Gariwerd as named by the local Aboriginals, is a photogenic sandstone range that runs north-south cutting through the Victorian plains.  Grampians National Park is about 160 miles west of Melbourne, so we set out early Monday morning in our little rental car with a goal to stay on the left side of the road and finally see some Kangaroos. -->
<!--  We reached the small town of Hall’s Gap at the base of the National Park and despite the windy and overcast conditions, we spent the day exploring the waterfalls, lookouts and canyons. -->
<!-- ““ -->
...
<!-- ““ -->
<!-- On Tuesday morning we left the hotel early in order to tackle one of the parks more popular hikes, The Pinnacle.  We needn’t have worried, since it was lightly showering and extremely windy. We were the only car at the trailhead both when we arrived and left, so we had the hike all to ourselves.  The solitude coupled with the dramatic weather made the summit of the Pinnacle eerie, and even though we didn’t get the sweeping views that hike normally promises, it was well worth the scramble. -->
