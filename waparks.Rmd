...
makeTblx <- function(visited_sf, 
  ...
  tblx <- data.frame(Metric = c('Date', 'Weather', 'Lat', 'Long'),
                     Measure = c(as.character(tbl$Date_Visited), as.character(tbl$Weather), 
...
```{r, echo = FALSE, cache = FALSE}
  ...
  head_col <- '#489f28'
  row_col <- "#edf5fc"
  summ_df <- readRDS(file.path(getwd(), 'images', paste0('summary.RDS')))

  summ_df %>%
   knitr::kable(., format = 'html') %>%
   kableExtra::kable_styling(full_width = F, stripe_color = strip_col) %>%
   kableExtra::row_spec(0, background = head_col) %>%
    kableExtra::pack_rows("Travel Details", 4, 8, label_row_css = "background-color: #666; color: #fff;")
...
<img src="images/waparks_millersvania.png" style="width:25%; border:1px solid; margin-left:20px; margin-right: 20px" align="right">
