...
| | |
| Parks Visited | 35 |
| Remaining to Visit | 101 |
| | |
| Miles Driven | 1087 |
| Miles Ferried | 14.5 |
| Miles Boated | 39.89  |
| Miles Hiked | 15.7 |
| Miles Paddleboarded | 1.2 |
| | |
| | |
...
tbl <- data.frame(`Stat` = c('Date', 'Lat', 'Long', 'Weather', 'Miles Boated'),
                  `.` = c('2020-07-14', '48.70084', '-122.76446', '70 / Sunny', '15.8'))
tbl <- tableGrob(tbl, rows = NULL, theme = tt2)
gridExtra::grid.arrange(rasterGrob(img), tbl,
                        nrow = 1,
                        as.table = TRUE)
```
...
tbl <- data.frame(`Stat` = c('Date', 'Lat', 'Long', 'Weather', 'Miles Boated',
                                'Miles Paddleboarded'),
                  `.` = c('2020-07-13', '48.61833', '-123.16798', '69 / Sunny', '20.4', '0.2'))
tbl <- tableGrob(tbl, rows = NULL, theme = tt2)
gridExtra::grid.arrange(rasterGrob(img), tbl,
                        nrow = 1,
                        as.table = TRUE)
...
tbl <- data.frame(`Stat` = c('Date', 'Lat', 'Long', 'Weather', 'Miles Boated', 'Miles Hiked'),
                  `.` = c('2020-07-13', '48.67396', '-123.21757', '68 / Sunny', '14.9', '1.1'))
tbl <- tableGrob(tbl, rows = NULL, theme = tt2)
gridExtra::grid.arrange(rasterGrob(img), tbl,
                        nrow = 1,
                        as.table = TRUE)
...
tbl <- data.frame(`Stat` = c('Date', 'Lat', 'Long', 'Weather', 'Miles Driven', 'Miles Paddleboarded'),
                  `.` = c('2020-07-13', '48.66498', '-122.82404', '65 / Sunny', '12.0', '1.0'))
tbl <- tableGrob(tbl, rows = NULL, theme = tt2)
gridExtra::grid.arrange(rasterGrob(img), tbl,
                        nrow = 1,
                        as.table = TRUE)
...
tbl <- data.frame(`Stat` = c('Date', 'Lat', 'Long', 'Weather', 'Miles Boated', 'Miles Hiked'),
                  `.` = c('2020-07-12', '48.60529', '-122.83183', '65 / Sunny', '6.2', '2.1'))
tbl <- tableGrob(tbl, rows = NULL, theme = tt2)
gridExtra::grid.arrange(rasterGrob(img), tbl,
                        nrow = 1,
                        as.table = TRUE)
...
<img src="images/waparks_suciaisland.jpg" style="width:300px; margin-right:20px;padding:30px;" align="right">
...
tbl <- data.frame(`Stat` = c('Date', 'Lat', 'Long', 'Weather', 'Miles Driven', 'Miles Ferried', 'Miles Hiked'),
                  `.` = c('2020-07-12', '48.60529', '-122.83183', '59 / P. Cloudy', '97.6', '14.9', '1.7'))
tbl <- tableGrob(tbl, rows = NULL, theme = tt2)
gridExtra::grid.arrange(rasterGrob(img), tbl,
                        nrow = 1,
                        as.table = TRUE)
...
<img src="images/waparks_obstructionpass.jpg" style="width:300px; margin-right:20px;padding:30px;" align="right">
...
<img src="images/map_deceptionpass.png" style="width:330px;padding:30px" align="left">
<img src="images/waparks_deceptionpass.jpg" style="width:300px; margin-right:20px;padding:30px;" align="right">

| Date |  Map Link | Lat | Long | Weather | Traveled |
| :-----: |:------: | :-------: |:-------: | :-------: |:------: |
| 2020-01-20 | [Map](https://www.google.com/maps/place/North+Beach/@48.3982467,-122.6658987,15z/data=!4m12!1m6!3m5!1s0x54857caeb43d67b5:0xa32ccd675fe1a55f!2sDeception+Pass+State+Park!8m2!3d48.4073784!4d-122.6445697!3m4!1s0x54857ccbe05a2c55:0xb86f9fd46006f816!8m2!3d48.4014909!4d-122.6554495) | 47.39824 | -122.66589 | 48 / Cloudy | 26.2 (car) / 11.7 (ferry) |
...
<img src="images/map_dashpoint.png" style="width:330px;padding:30px" align="left">
<img src="images/waparks_dashpoint.png" style="width:300px; margin-right:20px;padding:30px;" align="right">

| Date |  Map Link | Lat | Long | Weather | Traveled |
| :-----: |:------: | :-------: |:-------: | :-------: |:------: |
| 2020-01-05 | [Map](https://www.google.com/maps/place/Dash+Point+State+Park/@47.3183165,-122.4162708,15z/data=!4m5!3m4!1s0x549056c760de0a9b:0xbdd4ce3fd805cb00!8m2!3d47.3183129!4d-122.4075162) | 47.31831 | -122.41627 | 43 / Rainy | 43.0 (car) |
...
<img src="images/map_saltwater.png" style="width:330px;padding:30px" align="left">
<img src="images/waparks_saltwater.png" style="width:300px; margin-right:20px;padding:30px;" align="right">

| Date |  Map Link | Lat | Long | Weather | Traveled |
| :-----: |:------: | :-------: |:-------: | :-------: |:------: |
| 2020-01-05 |[Map](https://www.google.com/maps/place/Saltwater+State+Park/@47.37446,-122.3237796,16z/data=!4m5!3m4!1s0x54905a392cb3a9df:0x60f0bd43e192b77e!8m2!3d47.3744564!4d-122.3194022) | 47.37446 | -122.32377 | 43 / Rainy | 24.2 (car) |
...
<img src="images/map_lakesammamish.png" style="width:330px;padding:30px" align="left">
<img src="images/waparks_lakesammamish.JPG" style="width:300px; margin-right:20px;padding:30px;" align="right">

| Date |  Map Link | Lat | Long | Weather | Traveled |
| :-----: |:------: | :-------: |:-------: | :-------: |:------: |
| 2020-01-04| [Map](https://www.google.com/maps/place/Lake+Sammamish+State+Park/@47.5590578,-122.0650745,15z/data=!4m5!3m4!1s0x54906faf255d9715:0xfc18e427e1f261aa!8m2!3d47.5590542!4d-122.0563198) | 47.55905 | -122.06507 | 41 / Windy | 44.6 (car) |
...
<img src="images/map_saintedward.png" style="width:330px;padding:30px" align="left">
<img src="images/waparks_saintedward.png" style="width:300px; margin-right:20px;padding:30px;" align="right">

| Date |  Map Link | Lat | Long | Weather | Traveled |
| :-----: |:------: | :-------: |:-------: | :-------: |:------: |
| 2020-01-01 | [Map](https://www.google.com/maps/place/Saint+Edward+State+Park/@47.7325728,-122.3969877,11z/data=!4m5!3m4!1s0x5490118ca599d303:0x796ecd98c741f826!8m2!3d47.7325692!4d-122.256912) | 47.7325 | -122.2591 | 44 / P. Sunny | 22.2 (car) / 1.2 (hike) |
...
<img src="images/map_spencerspit.png" style="width:330px;padding:30px" align="left">
<img src="images/waparks_spencerspit.jpg" style="width:300px; margin-right:20px;padding:30px;" align="right">

\vspace{45mm}

| Date |  Map Link | Latitude | Longitude | Weather | Traveled |
| :-----: |:------: | :-------: |:-------: | :-------: |:------: |
| 2019-12-27 | [Map](https://www.google.com/maps/place/Spencer+Spit+State+Park/@48.536069,-122.861176,12z/data=!4m5!3m4!1s0x0:0xe0620a6877355ad4!8m2!3d48.536678!4d-122.8609479?hl=en) | 48.5360 | -122.8612 | 42 / Cloudy | 14.8 (car) |
