...
<!-- * Afternoon of beach combing and stalling on the interpretive trail.   -->
<!-- * Washout -->
<!-- * Seal -->
<!-- * Spiral oyster shell to keep the kids busy -->
<!-- * Damp and cold even with the small rays of sun which ducked behind the hill around 3pm -->
...
<!-- * Impressive parking lot and boat launch, with a beach that was hidden by the tide. -->
<!-- * Pivoted to Hamma Hamma to get some seafood and hike on the oyster piles -->
<!-- * Maybe we should have gotten food then picnicked at Triton cove...but a bit cold for an open air picnic -->
