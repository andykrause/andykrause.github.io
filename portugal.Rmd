...
pois <- data.frame(name = c('Sagres Lighthouse',
                            'Praia de Cavaiero',
                            ...
                            'Monsaraz'),
                  link = c(''),
                  latitude = c(36.993952, 37.096216, 38.771358, 37.007465,
                               37.850770, 38/4432),
                  longitude = c(-8.949362, -8.471925, -7.715587, -7.995174,
                                -8.79443, -7380857))
...
```{r, echo = FALSE, message = FALSE, warning=FALSE, comment = FALSE}
 ...
 map <- maplibre(style = maptiler_style("winter"),
  ...
  add_circle_layer(
    id = 'poi',
    source = pois_xsf,
    circle_color = 'darkorange',
    circle_radius = 3,
    circle_stroke_color = 'darkorange',
